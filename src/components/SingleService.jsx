...
const SingleService = () => {
  const servicesData = {
    'hair-treatment': {
      ...
      metaDescription: 'Expert hair treatment services at MJ Salon, Kalka JI Delhi. Precision cuts, vibrant coloring, keratin treatments, and professional styling for healthy, beautiful hair.',
      intro: 'Transform your look with expert hair services at <strong>MJ Salon by Mohit & Jatin</strong> in <strong>Kalka JI, Delhi</strong>. Our skilled stylists create stunning hairstyles that enhance your natural beauty.',
      description: 'Premium haircuts, coloring, keratin treatments, and styling services using top-quality products for healthy, shiny, gorgeous hair.',
      features: [
    ...
    'makeup': {
      ...
      metaDescription: 'Professional makeup services at MJ Salon, Delhi. Bridal makeup, party makeup, and special occasion looks by expert makeup artists using premium international brands.',
      intro: 'Enhance your natural beauty with professional makeup artistry at <strong>MJ Salon</strong>. Our certified makeup artists create <strong>flawless, long-lasting looks</strong> for every occasion.',
    ...
    'nail-extension': {
      ...
      metaDescription: 'Professional nail extension services at MJ Salon, Kalka JI. Acrylic nails, gel extensions, creative nail art, and meticulous grooming for stunning, durable nails.',
      intro: 'Get stunning, durable nails with professional <strong>nail extension services</strong> at <strong>MJ Salon</strong>. Our certified technicians create beautiful <strong>acrylic extensions</strong> and modern <strong>gel nails</strong>.',
    ...
    'pedicure': {
      ...
      metaDescription: 'Luxurious pedicure services at MJ Salon, Delhi. Relaxing spa treatments with exfoliation, therapeutic massage, and beautiful polish for soft, groomed feet.',
      intro: 'Treat yourself to luxurious <strong>pedicure services</strong> at <strong>MJ Salon</strong>. Our comprehensive foot care treatments combine relaxation with beauty.',
    ...
    'facial': {
      ...
      metaDescription: 'Rejuvenating facial treatments at MJ Salon, Kalka JI Delhi. Customized skincare using premium products for deep cleansing, hydration, brightening, and anti-aging results.',
      intro: 'Achieve radiant, glowing skin with rejuvenating <strong>facial treatments</strong> at <strong>MJ Salon</strong>. Our expert estheticians provide <strong>customized skincare solutions</strong> using premium products.',
              ...
              >
                <div className={`relative max-w-5xl ${isLeft ? '' : 'md:ml-auto'}`}>
                  ...
                  <div className="mb-6 sm:mb-8">
                    <h2 className="font-bold uppercase text-2xl sm:text-3xl md:text-4xl text-[#f5f5f5] mb-2">
                      {service.title}
                    </h2>
                  ...
                  <div className="bg-[#1a1a1a]/40 backdrop-blur-sm p-4 sm:p-6 lg:p-8 rounded-lg border border-[#c4a574]/20">
                    ...
                    {/* Description */}
                    <p className="text-sm sm:text-base leading-relaxed text-[#e0e0e0] mb-6">
                      {service.description}
                    </p>

                    {/* Features */}
                    <div>
                      <h4 className="font-bold uppercase text-base sm:text-lg md:text-xl text-[#f5f5f5] mb-4 flex items-center gap-2">
